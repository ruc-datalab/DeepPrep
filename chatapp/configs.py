...
LLM_CONFIGS: Dict[str, str] = {
    "Gpt-5": "multiturn_opchain_gpt5",
    "Claude-4": "multiturn_opchain_claude",
    "Doubao-Seed-1.6-Thinking": "multiturn_opchain_doubao",
    # NOTE: config file name in `_config/` is `_CONFIG_multiturn_opchain_doubao_flash.yaml`
    "Doubao-Seed-1.6-flash": "multiturn_opchain_doubao_flash",
    "DeepSeek-R1": "multiturn_opchain_r1",
    "DeepSeek-V3.1": "multiturn_opchain_v3.1",
}


DEFAULT_CONFIG_NAME = "multiturn_opchain_gpt5"
