...
Output:
<operators>
Join(left_table="table_1", right_table="table_2", left_on="festival id", right_on="festival id", how="inner")
[SPLIT_FLAG]
Pivot(table_name="table_1", index="location", columns="year", values="num of audience", aggfunc="mean")
[SPLIT_FLAG]
GroupBy(table_name="table_1", by=["location"], agg=[{"column": "num of audience", "agg_func": "sum"}])
[SPLIT_FLAG]
SelectCol(table_name="table_1", columns=["festival id", "festival name", "location"])
[SPLIT_FLAG]
SelectCol(table_name="table_2", columns=["artwork id", "festival id", "result"])
[SPLIT_FLAG]
</operators> 